...
export default function Hero() {
    ...
    return (
        <section className="relative h-screen w-full">
            ...
            <img ref={imageRef} src="/modelo_fondo.png" alt="Modelo de fondo" className=" absolute bottom-0 right-0 min-[1800px]:right-100 w-60 min-[300px]:w-65 min-[380px]:w-75 sm:w-80 md:w-100 lg:w-130 object-cover"/>
